...
FiscalNote is a policy intelligence platform that aggregates legislative, regulatory, and stakeholder data across Congress, all 50 U.S. states, and over 100 countries. Their developer platform offers APIs for programmatic access to policy data, government personnel records, and organizational information, with support for AI agent integrations through the Model Context Protocol (MCP).

**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/fiscalnote/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Government, Policy, Legislation, Regulation, Political Intelligence
...
#### Tags:
 ...
 - Policy, Legislation, Regulation, AI Agents, MCP, Compliance

#### Properties

- [Documentation](https://fiscalnote.com/products/policynote-api)
- [OpenAPI](openapi/fiscalnote-policynote-openapi.yml)
...
#### Tags:
 ...
 - Legislation, Regulation, Government Data, Bills

#### Properties

- [Documentation](https://apidocs.fiscalnote.com/apis)
- [OpenAPI](openapi/fiscalnote-appdata-openapi.yml)
...
#### Tags:
 ...
 - Government Officials, Politicians, Legislators

#### Properties

- [Documentation](https://apidocs.fiscalnote.com/apis)
- [OpenAPI](openapi/fiscalnote-people-openapi.yml)
...
#### Tags:
 ...
 - Government Organizations, Committees, Federal Agencies

#### Properties

- [Documentation](https://apidocs.fiscalnote.com/apis)
- [OpenAPI](openapi/fiscalnote-organization-openapi.yml)
